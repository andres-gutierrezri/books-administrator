...
class Libro(models.Model):
    ...
    CodigodeBarras = models.CharField(max_length=255, null=True, blank=True)
    NoTopografico = models.CharField(max_length=255, null=True, blank=True)
    ...
    Pagsovols = models.CharField(max_length=255, null=True, blank=True)
    Ejemplares = models.CharField(max_length=255, null=True, blank=True)
